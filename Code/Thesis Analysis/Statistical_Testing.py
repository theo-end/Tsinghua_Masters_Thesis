...
Confounding_Test_Columns_List = [['Total Cases per Million', 'Value'], ['Total Deaths per Million', 'Value'], ['Total Tests per Million', 'Value'], ['Case-Death Ratio', 'Value'], ['Test-Case Ratio', 'Value'],  
...
Oxford_Indices_Test_Column_List = [["Max Stringency", "Value"], ["Max Government Response", "Value"], ["Max Containment Health", "Value"], ["Max Economic Support", "Value"], ["Economic Support to Containment Health Ratio", "Value"], ["Economic Support to Stringency Ratio", "Value"], ["Economic Support to Government Response Ratio", "Value"],
                                   ["Num Days Some Sectors Closed", "Value"], ["Num Days All Non-Essential Sectors Closed", "Value"], ["Num Days Public Transport Closed", "Value"], ["Num Days Stay-at-Home except for Essential Trips", "Value"], ["Num Days Stay-at-Home Total Lockdown", "Value"], ["Num Days Internal Movement Restricted", "Value"], 
                                   ["Num Days Int'l Bans for some Countries", "Value"],  ["Num Days Int'l Bans Total Border Closure", "Value"],  ["Num Cases Before Some Sectors Closed", "Value"],  ["Avg Case Rate Before Some Sectors Closed", "Value"], ["Max Case Rate Before Some Sectors Closed", "Value"],  ["Num Cases Before All Non-Essential Sectors Closed", "Value"],
                                   ["Avg Case Rate Before All Non-Essential Sectors Closed", "Value"], ["Max Case Rate Before All Non-Essential Sectors Closed", "Value"],  ["Num Deaths Before Some Sectors Closed", "Value"], ["Avg Death Rate Before Some Sectors Closed", "Value"],  ["Max Death Rate Before Some Sectors Closed", "Value"], ["Num Deaths Before All Non-Essential Sectors Closed", "Value"],
                                   ["Avg Death Rate Before All Non-Essential Sectors Closed", "Value"], ["Max Death Rate Before All Non-Essential Sectors Closed", "Value"],  ["Num Cases Before Public Transport Closed", "Value"],  ["Avg Cases Rate Before Public Transport Closed", "Value"],  ["Max Case Rate Before Public Transport Closed", "Value"],
                                   ["Num Deaths Before Public Transport Closed", "Value"], ["Avg Deaths Rate Before Public Transport Closed", "Value"],  ["Max Death Rate Before Public Transport Closed", "Value"],  ["Num Cases Before Stay-at-Home except for Essential Trips",  "Value"],  ["Avg Cases Rate Before Stay-at-Home except for Essential Trips", "Value"],
                                   ["Max Case Rate Before Stay-at-Home except for Essential Trips", "Value"],
                                   ["Num Deaths Before Stay-at-Home except for Essential Trips", "Value"], ["Avg Deaths Rate Before Stay-at-Home except for Essential Trips", "Value"], ["Max Death Rate Before Stay-at-Home except for Essential Trips", "Value"],
                                   ["Num Cases Before Stay-at-Home Total Lockdown", "Value"], ["Avg Cases Rate Before Stay-at-Home Total Lockdown", "Value"], ["Max Case Rate Before Stay-at-Home Total Lockdown", "Value"], ["Num Deaths Before Stay-at-Home Total Lockdown", "Value"],
                                   ["Avg Deaths Rate Before Stay-at-Home Total Lockdown", "Value"], ["Max Death Rate Before Stay-at-Home Total Lockdown", "Value"], ["Num Cases Before Internal Movement Restricted", "Value"], ["Avg Cases Rate Before Internal Movement Restricted", "Value"],
                                   ["Max Case Rate Before Internal Movement Restricted", "Value"], ["Num Deaths Before Internal Movement Restricted", "Value"], ["Avg Deaths Rate Before Internal Movement Restricted", "Value"], ["Max Death Rate Before Internal Movement Restricted", "Value"],
                                   ["Num Cases Before Int'l Bans for some Countries", "Value"], ["Avg Cases Rate Before Int'l Bans for some Countries", "Value"], ["Max Case Rate Before Int'l Bans for some Countries", "Value"], ["Num Deaths Before Int'l Bans for some Countries", "Value"],
                                   ["Avg Deaths Rate Before Int'l Bans for some Countries", "Value"], ["Max Death Rate Before Int'l Bans for some Countries", "Value"], ["Num Cases Before Int'l Bans Total Border Closure", "Value"], ["Avg Cases Rate Before Int'l Bans Total Border Closure", "Value"], 
                                   ["Max Case Rate Before Int'l Bans Total Border Closure", "Value"], ["Num Deaths Before Int'l Bans Total Border Closure", "Value"], ["Avg Deaths Rate Before Int'l Bans Total Border Closure", "Value"], ["Max Death Rate Before Int'l Bans Total Border Closure", "Value"],
                                   ["Num Cases Before Peak Stringency", "Value"], ["Avg Case Growth Before Peak Stringency", "Value"], ["Max Case Growth Before Peak Stringency", "Value"], ["First Max Stringency to Preceding Cases Ratio", "Value"],
                                   ["Num Deaths Before Peak Stringency", "Value"], ["Avg Death Growth Before Peak Stringency", "Value"], ["Max Death Growth Before Peak Stringency", "Value"], ["First Max Stringency to Preceding Deaths Ratio", "Value"],
                                   ["Num Cases Before Peak Containment Health", "Value"], ["Avg Case Growth Before Peak Containment Health", "Value"], ["Max Case Growth Before Peak Containment Health", "Value"], ["First Max Containment Health to Preceding Cases Ratio", "Value"],
                                   ["Num Deaths Before Peak Containment Health", "Value"], ["Avg Death Growth Before Peak Containment Health", "Value"], ["Max Death Growth Before Peak Containment Health", "Value"], ["First Max Containment Health to Preceding Deaths Ratio", "Value"],
                                   ["Num Cases Before Peak Economic Support", "Value"], ["Avg Case Growth Before Peak Economic Support", "Value"], ["Max Case Growth Before Peak Economic Support", "Value"], ["First Max Economic Support to Preceding Cases Ratio", "Value"],
                                   ["Num Deaths Before Peak Economic Support", "Value"], ["Avg Death Growth Before Peak Economic Support", "Value"], ["Max Death Growth Before Peak Economic Support", "Value"], ["First Max Economic Support to Preceding Deaths Ratio", "Value"],
                                   ["Num Cases Before Peak Government Response", "Value"], ["Avg Case Growth Before Peak Government Response", "Value"], ["Max Case Growth Before Peak Government Response", "Value"], ["First Max Government Response to Preceding Cases Ratio", "Value"],
                                   ["Num Deaths Before Peak Government Response", "Value"], ["Avg Death Growth Before Peak Government Response", "Value"], ["Max Death Growth Before Peak Government Response", "Value"], ["First Max Government Response to Preceding Deaths Ratio", "Value"]]


        

Correlation_Testing(Confounding_Base_Columns_List, Confounding_Test_Columns_List, "Confounding_Variable_Correlation_Graphs", False, "Confounding_Variable_Correlation_Tables", True, Country_Metrics)
Correlation_Testing(Pandemic_Prepardness_Base_Columns_List, Confounding_Test_Columns_List, "Pandemic_Prepardness_Correlation_Graphs", False, "Pandemic_Prepardness_Correlation_Tables", True, Country_Metrics)
